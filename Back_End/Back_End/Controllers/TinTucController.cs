...
namespace Back_End.Controllers
{
    ...
    public class TinTucController : ControllerBase
    {
        ...
        public TinTucController(doantotnghiepContext context, IWebHostEnvironment environment)
        {
            _context = context;
        ...
        public IActionResult GetALL()
        {
            try
            {
                ...
                {
                    id = x.Id,
                    loaitin = x.LoaiTin.TenLoaiTin,
                    image = x.DuongDanAnh,
                    tieuDe = x.TieuDe,
                    noiDung = x.NoiDung,
                    nguoiViet = x.NguoiViet.HoTen
                }).ToList();
                return Ok(query);
            }
            catch (Exception ex)

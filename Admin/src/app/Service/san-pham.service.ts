...
export class SanPhamService {
    ...
    create(SanPham: any): Observable<any> {
        return this.http.post<any>(
            baseUrl + 'api/SanPham/Create_SanPham',
            SanPham
        );
    }
    update(SanPham: any) {
        return this.http.put<any>(
            baseUrl + 'api/SanPham/Update_SanPham',
            SanPham
        );
    }
    toggleTrangThai(id: any) {
        return this.http.put<any>(
            baseUrl + `api/SanPham/TrangThai/${id}`,
            null
        );
    }
    delete(id: number): Observable<any> {
        return this.http.delete<any>(
            baseUrl + 'api/SanPham/Delete_SanPham/' + id
        );
    }
    getById(id: any): Observable<any> {
        return this.http.get<any>(
            baseUrl + 'api/SanPham/GetById_SanPham/' + id
        );
    }

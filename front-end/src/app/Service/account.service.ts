...
export class AccountService {
  ...
  signUp(khachhang: any) {
    return this.http.post<any>(baseUrl + 'api/Client/Register', khachhang);
  }

  signIn(khachhang: any) {
    return this.http.post<any>(baseUrl + 'api/Client/Signin', khachhang);
  }
  ...
  renewToken(tokenApi: any) {
    return this.http.post<any>(baseUrl + 'api/Client/RefreshToken', tokenApi);
  }
}
